...
https://captura/ejecucion.png

Resultado BFS
https://captura/bfs_resultado.png

Resultado Dijkstra
https://captura/dijkstra_resultado.png
...
🔗 Repositorio
https://github.com/Alexis112008/ProyectoAPE4
...
Solo copia y pega esto en tu `README.md`. Luego agrega tus tres capturas dentro de la carpeta `captura/` con los nombres: `ejecucion.png`, `bfs_resultado.png` y `dijkstra_resultado.png`.